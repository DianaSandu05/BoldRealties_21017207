...
namespace BoldRealties.DAL.Migrations
{
    ...
    [Migration("20220525055034_initial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BoldRealties.Models.jobs", b =>
                {
                    ...
                    b.Property<float?>("QuotationPrice")
                        .HasColumnType("real");
            ...
            modelBuilder.Entity("BoldRealties.Models.OrderDetails", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BoldRealties.Models.OrderHeader", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BoldRealties.Models.ShoppingCart", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BoldRealties.Models.OrderDetails", b =>
                {
                    b.HasOne("BoldRealties.Models.OrderHeader", "OrderHeader")
                        .WithMany()
